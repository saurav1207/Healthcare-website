  ...
  return (
    <>
      <div className="col-md-3">
        <div className="card m-2" style={{ cursor: "pointer", boxShadow: "0px 0px 5px rgba(0, 0, 0, 0.1)" }} >
          <div className="card-header d-flex flex-column align-items-center">
            <Avatar src={doctor.avatar} className="mb-2" size={64} />
            <div className="text-center">
              <h4 className="mb-0 text-truncate">Dr. {doctor.firstName} {doctor.lastName}</h4>
          ...
          <div className="card-body d-flex justify-content-center align-items-center">
            <div className="d-flex flex-column justify-content-center">
              ...
              <div className="d-flex justify-content-start align-center">
                <Button type="primary" onClick={() => navigate(`/doctor/book-appointment/${doctor._id}`)}>Book Appointment</Button>
              </div>
            </div>
          </div>
        </div>
